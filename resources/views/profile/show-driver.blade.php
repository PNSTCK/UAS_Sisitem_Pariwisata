...
<body>
    @include('layouts.be.top-navdriver')
    @include('layouts.be.sidebar-driver')
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="tab-content pt-2">
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Jenis Mobil</div>
                                        <div class="col-lg-9 col-md-8">{{ $user->jenis_mobil }}</div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Plat Nomor</div>
                                        <div class="col-lg-9 col-md-8">{{ $user->plat_nomor }}</div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Warna Mobil</div>
                                        <div class="col-lg-9 col-md-8">{{ $user->warna_mobil }}</div>
                                    </div>
                                </div>
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    <form action="{{ route('profile.update') }}" method="POST"
                                        ...
                                        <div class="row mb-3">
                                            <label for="jenis_mobil" class="col-md-4 col-lg-3 col-form-label">Jenis
                                                Mobil</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="jenis_mobil" type="text" class="form-control"
                                                    id="jenis_mobil" value="{{ $user->jenis_mobil }}">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="plat_nomor" class="col-md-4 col-lg-3 col-form-label">Plat
                                                Nomor</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="plat_nomor" type="text" class="form-control"
                                                    id="plat_nomor" value="{{ $user->plat_nomor }}">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            <label for="warna_mobil" class="col-md-4 col-lg-3 col-form-label">Warna
                                                Mobil</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="warna_mobil" type="text" class="form-control"
                                                    id="warna_mobil" value="{{ $user->warna_mobil }}">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
